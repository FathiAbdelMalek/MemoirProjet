"""
Django settings for MemoirProjet project.
...
SECRET_KEY = 'eii91w9^)b273!t-2aw%*sc(r2$!^pexy)wez4yy&m$2htjs39'
...
ROOT_URLCONF = 'MemoirProjet.urls'
...
WSGI_APPLICATION = 'MemoirProjet.wsgi.application'
...
EMAIL_HOST_PASSWORD = 'Fathi_CJPP@2001'
