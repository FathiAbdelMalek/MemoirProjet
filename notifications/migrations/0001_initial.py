    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.IntegerField(choices=[(0, 'New Submission'), (1, 'Edited Submission'), (2, 'Accept Demand'), (3, 'Refuse Demand')])),
                ...
                ('demand', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='demand', to='conferences.submission')),
