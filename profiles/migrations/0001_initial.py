    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sexe', models.CharField(blank=True, choices=[('Male', 'Male'), ('Female', 'Female')], max_length=6, null=True)),
                ('country', django_countries.fields.CountryField(blank=True, max_length=2, null=True)),
                ('work_place', models.CharField(blank=True, max_length=30, null=True)),
                ('degree', models.CharField(blank=True, choices=[('Student', 'Student'), ('MBB', 'MBB'), ('MBA', 'MBA'), ('MCB', 'MCB'), ('MCA', 'MCA'), ('Professor', 'Professor')], max_length=9, null=True)),
